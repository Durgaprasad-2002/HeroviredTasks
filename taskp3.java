...
public class taskp3{
    ...
    static int ProductsCount[]={20,5,30,50};
    static String Products[]={"Mobiles","Laptops","Speakers","HeadPhones"};
    static int ProductsCost[]={12000,50000,1000,1500};
    ...
    //method to edit the count of Product
    ...
    static void EditProductDetails(){
        ...
        System.out.println("New Specifications are updated");
    }
    //to display Products
